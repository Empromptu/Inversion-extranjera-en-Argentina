...
# Trabajo Practico 1, Laboratorio de datos 1C 2024, Grupo 3
...
# Documentacion del proceso: https://github.com/GuidoPauletti/Inversion-extranjera-en-Argentina/blob/main/notas.ipynb

# Como primera medida importamos todas las herramientas necesarias.
import pandas as pd
import numpy as np
